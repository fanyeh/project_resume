  ...
  return (
    <div className="experienceContainer ml3 pl4 pb3">
      <div className="near-black">
        <h1 className="dib ma0 f5-ns f6 ttc">{props.title}</h1>
        <h1 className="dib ma0 f5-ns f6 fr">{props.date}</h1>
      </div>
      <p className="bb b--moon-gray pb3 f5-ns f6 fw3 gray lh-copy">
